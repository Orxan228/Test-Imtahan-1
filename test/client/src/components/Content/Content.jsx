    ...
    <div className="content">
      <div className="content___best">
        <div className="content___best___txt">
          <div className="content___best___txt___p1">Best IT Solution in your city</div>
          <div className="content___best___txt___line"></div>
          <div className="content___best___txt___p2">Prevent data loss with encrypted storage and virtualized recovery, then enjoy increased productivity.</div>
          <button>Find Out More</button>
        </div>
      </div>
      <div className="content___manage">
        <p className="content___manage--s1">INDUSTRY WE OFFER</p>
        <p className="content___manage--s2">Managed IT services customized for your industry</p>
        <p className="content___manage--s3">We understand the complexities of modern markets and translate them into real business solutions for automotive, financial, insurance, pharma & life sciences,</p>
    ...
    <div className="content___insights">
      <div className="content___insights___top">
        <div className="content___insights___top___txt">
          <p className="content___insights___top___txt--p1">Insights to help you do what you do better, faster and more profitably.</p>
          <p className="content___insights___top___txt--p2">We understand the complexities of modern markets and translate them into real business solutions for automotive, financial, insuranc.</p>
      ...
      <div className="content___insights___bottom">
        <ul>
          <li><img src="https://preview.colorlib.com/theme/itlock/assets/img/gallery/brand1.png.webp" alt="" /></li>
          <li><img src="https://preview.colorlib.com/theme/itlock/assets/img/gallery/brand2.png.webp" alt="" /></li>
          <li><img src="https://preview.colorlib.com/theme/itlock/assets/img/gallery/brand3.png.webp" alt="" /></li>
          <li><img src="https://preview.colorlib.com/theme/itlock/assets/img/gallery/brand4.png.webp" alt="" /></li>
          <li><img src="https://preview.colorlib.com/theme/itlock/assets/img/gallery/brand5.png.webp" alt="" /></li>
        </ul>
      </div>
    </div>
