    ...
    <div className="footer">
      <div className="footer___top">
        <div className="footer___top--section footer__setion-1">
          ...
          <p className='footer__setion-1--p2'>We understand the complexities of modern markets and translate them into real business solutions for automotive, financial, insuranc.</p>
        ...
        <div className="footer___top--section footer__setion-5">
          ...
          <ul className='footer__setion-5-list'>
              <li className='footer__setion-5-list-item item-1'><FacebookIcon style={{fontSize:"1.2rem", color:"white"}}/></li>
              <li className='footer__setion-5-list-item item-2'><YouTubeIcon style={{fontSize:"1.2rem", color:"white"}}/></li>
              <li className='footer__setion-5-list-item item-3'><LinkedInIcon style={{fontSize:"1.2rem", color:"white"}}/></li>
              <li className='footer__setion-5-list-item item-4'><InstagramIcon style={{fontSize:"1.2rem", color:"white"}}/></li>
          </ul>
        </div>
      </div>
      <div className="footer___bottom">
        <p>Copyright ©2023 All rights reserved | This template is made with <FavoriteIcon style={{fontSize:"1.2rem", color:"#00c1cf"}}/> by Colorlib</p>
      </div>
    </div>
    </>
  )
